...
dependencies { implementation(project(":core")); implementation(project(":crypto")); implementation(project(":security")); implementation(project(":network")); testImplementation("junit:junit:4.13.2") }
