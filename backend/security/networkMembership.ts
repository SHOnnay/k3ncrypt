...
export type NetworkMemberRecord = { networkId: string; accountIdentityReference: string; deviceId: string; identityReference: string; state: 'active' | 'removed'; epoch: number; capabilities: readonly string[]; updatedAt: number };
