export type ConversationCreationPolicy = 'legacy-default' | 'modern-explicit' | 'modern-default-beta';
...
export const conversationCreationPolicy = (): ConversationCreationPolicy => {
    ...
    return configured === 'modern-default-beta' || configured === 'modern-explicit' ? configured : 'legacy-default';
};
...
): PersistedConversationMode => policy === 'modern-default-beta' ? 'modern' : 'legacy';
